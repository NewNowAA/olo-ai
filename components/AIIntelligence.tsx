  ...
  const handleSendMessage = async () => {
    ...
    try {
        ...
        const response = await ai.models.generateContent({
            ...
            contents: inputText, // In a real app, pass conversation history here
            config: {
                systemInstruction: "Você é Lumea, uma assistente financeira corporativa inteligente, útil e concisa. Você ajuda com análise de dados, previsões de fluxo de caixa e gestão de faturas.",
            }
        });

        const aiText = response.text || "Desculpe, não consegui processar sua solicitação no momento.";
