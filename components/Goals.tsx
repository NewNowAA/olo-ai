  ...
  const generateAIAnalysis = async () => {
      ...
      try {
        ...
        const response = await ai.models.generateContent({
            ...
            contents: `Analise essas metas corporativas e dê um feedback curto e estratégico de 2 frases sobre como acelerar o progresso:\n${goalsList}`,
        });
        
        setAiAdvice(response.text || "Análise concluída. Mantenha o foco nos prazos curtos.");
      } catch (e) {
